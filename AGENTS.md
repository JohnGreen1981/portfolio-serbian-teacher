...
`schema.sql` содержит демо-структуру и нейтральную учебную программу A1. Материалы из конкретных учебников или курсов не включать без прав на публикацию; для публичного repo использовать оригинальный demo content.
